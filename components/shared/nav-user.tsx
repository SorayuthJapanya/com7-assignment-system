...
// เรียกใช้ AppLauncher ที่อยู่โฟลเดอร์เดียวกันมาผูกตำแหน่ง
...
export default function NavUser() {
  ...
  return (
    <div className="flex items-center gap-3">
      {/* วางปุ่มแอปตัวล่าสุดไว้ข้างหน้าปุ่มตั้งค่า เพื่อบังคับให้อยู่มุมขวาบนในระนาบแนวนอนพอดี */}
      <AppLauncher />

      {/* Dropdown Profile เดิม */}
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="flex items-center gap-2 px-2 py-1.5 rounded-md hover:bg-sidebar-accent transition-colors outline-none whitespace-nowrap" type="button">
